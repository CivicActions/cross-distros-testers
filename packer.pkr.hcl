...
build {
  source "vagrant.defaults" {
    ...
    output_dir  = "ubuntu_1804_distro"
  }
  source "vagrant.defaults" {
    source_path = "generic/ubuntu1804"
    name        = "ubuntu_1804_upstream"
    output_dir  = "ubuntu_1804_upstream"
  }
  source "vagrant.defaults" {
    source_path = "generic/ubuntu2004"
    name        = "ubuntu_2004_distro"
    output_dir  = "ubuntu_2004_distro"
  }
  source "vagrant.defaults" {
    source_path = "generic/ubuntu2004"
    name        = "ubuntu_2004_upstream"
    output_dir  = "ubuntu_2004_upstream"
  }
  source "vagrant.defaults" {
    source_path = "generic/rhel7"
    name        = "rhel_7_distro"
    output_dir  = "rhel_7_distro"
  }
# Disabled: see https://github.com/docker/for-linux/issues/1111
#  source "vagrant.defaults" {
#    source_path = "generic/rhel7"
#    name        = "rhel_7_upstream"
#    output_dir  = "rhel_7_upstream"
#  }
  source "vagrant.defaults" {
    source_path = "generic/rhel8"
    name        = "rhel_8_upstream"
    output_dir  = "rhel_8_upstream"
  }
  source "vagrant.defaults" {
    source_path = "generic/centos7"
    name        = "centos_7_distro"
    output_dir  = "centos_7_distro"
  }
  source "vagrant.defaults" {
    source_path = "generic/centos7"
    name        = "centos_7_upstream"
    output_dir  = "centos_7_upstream"
  }
  source "vagrant.defaults" {
    source_path = "generic/centos8"
    name        = "centos_8_upstream"
    output_dir  = "centos_8_upstream"
  }
  source "vagrant.defaults" {
    source_path = "generic/arch"
    name        = "arch_0_distro"
    output_dir  = "arch_0_distro"
  }
  provisioner "shell" {
  ...
  provisioner "ansible-local" {
    ...
    inventory_groups = [
      "distro_version_${regex_replace(source.name, "_[^_]+$", "")}",
